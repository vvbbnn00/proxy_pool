...
from util.proxyBypassRequest import ProxyBypassRequest
...
class ProxyFetcher(object):
    ...
    def freeProxy01():
        ...
        if interval.seconds < 24 * 3600:  # 只采集24小时内的代理
    ...
    def freeProxy02():
        """
        69ip http://www.69ip.cn/
        """
        url = "http://www.69ip.cn/?page=1"
        try:
    ...
    def freeProxy08():
        ...
        for url in urls:
            r = ProxyBypassRequest().get(url, timeout=60)
